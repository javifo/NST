...
#elif defined(CONFIG_3621GOSSAMER) && defined(CONFIG_SDRAM_MT46H64M32LF)
  #define SDP_SDRC_MDCFG_0_DDR	(0x03588099)	 /* Micron 2Gb SDRAM MT46H64M32LF module */
#elif defined(CONFIG_3621GOSSAMER) && defined(CONFIG_SDRAM_H5MS2G22MFR) 
  #define SDP_SDRC_MDCFG_0_DDR	(0x03588099)	 /* Hynix 2Gb SDRAM H5MS2G22MFR module */
...
#if defined(CONFIG_3621GOSSAMER) && defined(CONFIG_SDRAM_MT46H64M32LF)
...
#elif defined(CONFIG_3621GOSSAMER) && defined(CONFIG_SDRAM_H5MS2G22MFR)
/* Hynix part of 3621 EDP1 (166MHz optimized) 6.02ns - 256MB
*     ACTIMA
*        -TDAL = Twr/Tck + Trp/tck = 15/6 + 18/6 = 2.5 + 3 = 5.5 -> 6
*        -TDPL (Twr) = 15/6       = 2.5 -> 3
*        -TRRD = 12/6     = 2
