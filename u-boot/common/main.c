...
#if defined(CONFIG_3621EVT1A) || defined (CONFIG_3621GOSSAMER)
#include "power/gpio.h"
#include <asm/io.h>
#include "tps65921.h"

extern int gossamer_charger_init(void);

#endif /* CONFIG_3621EVT1A || CONFIG_3621GOSSAMER */
...
#if defined (CONFIG_BOARD_EARLY_CONSOLE)
    board_early_console();
#endif
