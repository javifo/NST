...
#define BOARD_OMAP3621_GOSSAMER 0x12
...
// Revisit - this system_rev should really be the full HWID register
#define BOARD_ENCORE_PROD_WLAN      0x0
#define BOARD_ENCORE_PROD_3G        (0x1 << 3)

#define BOARD_GOSSAMER_REV_EVT0     0x0
#define BOARD_GOSSAMER_REV_EVT1A    0x1
#define BOARD_GOSSAMER_REV_EVTPRE1C 0x2
#define BOARD_GOSSAMER_REV_EVT1C    0x3
#define BOARD_GOSSAMER_REV_EVT2     0x4
#define BOARD_GOSSAMER_REV_EVT3     0x5
#define BOARD_GOSSAMER_REV_DVT  	0x6
#define BOARD_GOSSAMER_REV_UNKNOWN 	0x7
