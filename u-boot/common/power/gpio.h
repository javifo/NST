...
/* ========================================================================== */
/**
*  gpio_pin_write()    sets and initializes two gpio pins in the same bank
*
*  @param   gpio_pin1           gpio number for pin 1
*  @param   gpio_pin1_level     level for pin 1
*  @param   gpio_pin2           gpio number for pin 2
*  @param   gpio_pin2_level     level for pin 2
*
*  @return  return_value    0 if no error
*
*  @pre     pre_conditions
*
*  @post    post_conditions
